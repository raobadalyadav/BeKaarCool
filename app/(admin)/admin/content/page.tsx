  ...
  return (
    <div className="p-6 lg:p-8">
      ...
      <div className="flex gap-1 mb-6">
        <button
          onClick={() => setTab("blog")}
          className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium transition-colors ${tab === "blog" ? "bg-yellow-400 text-black" : "bg-white border text-gray-600 hover:bg-gray-50"}`}
        >
          <FileText className="w-4 h-4" /> Blog Posts ({blogPosts.length})
        </button>
        <button
          onClick={() => setTab("banners")}
          className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium transition-colors ${tab === "banners" ? "bg-yellow-400 text-black" : "bg-white border text-gray-600 hover:bg-gray-50"}`}
        >
      ...
      <div className="mt-6 bg-yellow-50 border border-yellow-200 rounded-xl p-4">
        <p className="text-sm font-semibold text-yellow-800 mb-1">Rich Text Editor Coming Soon</p>
