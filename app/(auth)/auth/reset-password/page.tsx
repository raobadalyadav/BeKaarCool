        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 text-center">
            ...
            <Link href="/auth/forgot-password">
              <Button className="w-full h-12 bg-brand-500 hover:bg-brand-600 text-black font-bold">
                Request New Reset Link
              </Button>
            </Link>
            <Link href="/auth/login" className="block mt-4 text-gray-600 hover:text-brand-500">
              Back to login
            </Link>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <div className="text-center pt-4">
              <Link href="/auth/login" className="text-gray-600 hover:text-brand-500 text-sm">
                Back to login
              </Link>
            </div>
          </form>
