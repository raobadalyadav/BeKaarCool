...
export async function GET(request: NextRequest) {
  try {
    ...
    return NextResponse.json({
      general: {
        siteName: result.store?.name || "Baefikra",
        siteDescription:
          result.store?.description || "India's coolest fashion destination",
        siteUrl: result.store?.url || "https://baefikra.com",
        logo: "",
        favicon: "",
        contactEmail: result.store?.email || "support@baefikra.com",
        supportEmail: result.store?.email || "support@baefikra.com",
      ...
      email: {
        ...
        smtpUser: "",
        smtpPass: "",
        fromEmail: result.store?.email || "noreply@baefikra.com",
        fromName: result.store?.name || "Baefikra",
      },
      payment: {
        razorpayKeyId: "",
        razorpayKeySecret: "",
      ...
      seo: {
        metaTitle: result.store?.name || "Baefikra",
