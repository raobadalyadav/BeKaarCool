    ...
    <Card>
      ...
      <CardContent>
        <p className="text-sm text-gray-600">
          ...
          <a className="text-brand-500 underline" href="/account/profile">Profile</a> page.
        </p>
      </CardContent>
    </Card>
  );
      ...
      <CardContent className="space-y-4">
        {phase === "idle" && (
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 p-4 bg-gray-50 rounded-lg">
            ...
            <Button onClick={startSetup} disabled={loading} className="bg-brand-500 hover:bg-brand-600 text-black font-bold">
