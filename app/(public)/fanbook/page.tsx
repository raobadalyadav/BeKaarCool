...
const steps = [
  {
    ...
    color: "bg-brand-50 text-brand-500 border-orange-200",
  },
  {
    icon: Camera,
    step: "2",
...
export default function FanbookPage() {
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero */}
      <div className="bg-gradient-to-br from-brand-500 via-orange-400 to-orange-300 py-20 px-4 text-center">
        <Badge className="mb-4 bg-black text-brand-500 text-xs font-bold tracking-widest uppercase border-0">
          Community
        </Badge>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-16">
        ...
        <section className="bg-white border rounded-2xl p-8 text-center shadow-sm">
          <Star className="w-10 h-10 text-brand-500 mx-auto mb-3" />
          ...
          <Link href="/account/orders">
            <Button className="bg-brand-500 hover:bg-brand-600 text-white font-bold gap-2 px-8">
