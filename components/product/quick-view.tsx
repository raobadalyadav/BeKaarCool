                            ...
                            <div className="flex gap-2 overflow-x-auto">
                                {product.images.slice(0, 5).map((img, idx) => (
                                    <button
                                        ...
                                        className={`w-16 h-16 relative rounded border-2 flex-shrink-0 ${currentImage === idx ? "border-brand-500" : "border-gray-200"
                                            }`}
                                    >
                    ...
                    <div>
                        ...
                        <div className="flex gap-3 mb-4">
                            <Button
                                ...
                                className="flex-1 bg-brand-500 hover:bg-brand-600 text-black font-bold"
                            >
                        ...
                        <Link href={`/products/${product.slug}`}>
                            <Button variant="link" className="w-full text-brand-500">
